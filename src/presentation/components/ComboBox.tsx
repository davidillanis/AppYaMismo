...
import { ComboBoxItem, ComboBoxProps } from "@/src/domain/types/ComboBox";
...
const ComboBox: React.FC<ComboBoxProps> = ({
  ...
  const selectedItem = useMemo(() => {
    return internalItems.find(item => item.value === value);
  }, [internalItems, value]);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text style={selectedItem ? styles.selectedText : styles.placeholderText} numberOfLines={1}>
